        ...
        <>
            ...
            <div className="mainCont">
                <div className="contContac">
                    ...
                    <p className="ubi">Calle 5 de Mayo S / N, Colonia Lázaro Cárdenas, Chiconcuac en Xochitepec, Morelos, México. CP 62790</p>
                ...
                <p className="fs-4">Danos tus dudas y comentarios</p>
                    ...
                    <form className="formCont">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name="Nombre" id="Nombre" placeholder="Ingresa tu nombre completo" />
                        </div>
                        
                        <div className="mb-3">
                            <label htmlFor="correo" className="form-label">Correo electrónico</label>
                            <input type="email" className="form-control" name="correo" id="correo" placeholder="Ingresa tu correo electrónico" />
                        </div>
                        
                        <div className="mb-3">
                            <label htmlFor="tel" className="form-label">Número de teléfono</label>
                            <input type="tel" className="form-control" name="tel" id="tel" placeholder="Ingresa tu número de teléfono" />
                        </div>
                        
                        <div className="mb-3">
                            <label htmlFor="coments" className="form-label">Comentarios</label>
                            <textarea className="form-control" name="coments" id="coments" rows="5" placeholder="Escribe tus comentarios aquí"></textarea>
                        </div>
