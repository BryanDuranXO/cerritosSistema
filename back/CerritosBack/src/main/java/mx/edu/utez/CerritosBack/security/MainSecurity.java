package mx.edu.utez.CerritosBack.security;

import mx.edu.utez.CerritosBack.security.jwt.JwtAuthenticationFilter;
import mx.edu.utez.CerritosBack.security.service.UserDetailsServiceImpl;
        ...
        http.cors(Customizer.withDefaults()).csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST).permitAll()
                                ...
                                .requestMatchers("/api/simnil/**").hasAnyAuthority("Admin", "Huesped")
